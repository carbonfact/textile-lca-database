...
Arafat, Y., & Uddin, A. J. (2022). Recycled fibers from pre- and post-consumer textile waste as blend constituents in manufacturing 100% cotton yarns in ring spinning: A sustainable and eco-friendly approach. *Heliyon, 8*(11), e11330.

Altun, S. (2012). Prediction of textile waste profile and recycling opportunities in Turk. *Fibres & Textiles in Eastern Europe, 20*(5), 20--25.

Babel, N., Toma, A., & Sivanandan, A. (2019). *Comparative Life Cycle Assessment (LCA) of second-hand vs new clothing*. Green Story Inc.

Danish Environmental Protection Agency. (2007). *EDIPTEX: Environmental assessment of textiles*. Copenhagen, Denmark.

European Commission. (2003). *Reference document on best available techniques for the textiles industry (Textiles BREF)*. Integrated Pollution Prevention and Control (IPPC) Bureau.

European Commission Joint Research Centre. (2024). *Supporting document for the LCA--LCC model for textiles* (SusProc Textiles, version 2024-12-17).

Faysal, G. M., Hawlader, M. R., & Hossain, M. M. (2021). Lubrication and tribological problem in textile industry. *International Journal of Advances Research in Science and Engineering, 10*(1), 1--10.

Fimreite, L. A., & Blomstrand, K. (2009). *Berakning av textila produkters CO2-avtryck* [Calculation of textile products' CO2 footprint]. University of Boras.
...
Koc, E., & Kaplan, E. (2007). *An investigation on energy consumption in yarn production with special reference to ring spinning*. Cukurova University, Textile Engineering Department, Adana, Turkey.
...
Mahmood, A. (2020). Smart lean in ring spinning -- a case study to improve performance of yarn manufacturing process. *The Journal of The Textile Institute, 111*(11), 1681--1696.

Nautiyal, M., Cleveland, D., Hunting, A., & Smith, A. (2025). Legacy datasets and their impacts: Analysing ecoinvent's influence on wool and polyester LCA outcomes. *Sustainability, 17*(14), 6513.

Ozturk, E. (2005). Energy management in textile mills. In *Proceedings of the 5th International Textile, Clothing & Design Conference* (pp. 345--352).

Roos, S., Sandin, G., Zamani, B., & Peters, G. M. (2015). Environmental assessment of Swedish fashion consumption -- Five garments, sustainable futures. In *Mistra Future Fashion* project report.

Sashina, E. S., & Yakovleva, O. I. (2023). The current state and prospects of recycling silk industry waste into nonwoven materials. *Fibers, 11*(6), 56.

Sen, K., Bahrami, S. H., & Bajaj, P. (1996). High-performance acrylic fibers. *Journal of Macromolecular Science, Part C: Polymer Reviews, 36*(1), 1--76.

Swerea IVF. (2018). *Swerea IVF's LCA database*. Molndal, Sweden: Swerea IVF AB.

Textile Exchange. (2019). *CFMB fiber conversion methodology* (Version 1.0). Textile Exchange.

Tesema, G. B. (2024). Cotton quality requirements for spinning. In G. B. Tesema (Ed.), *Cotton sector development in Ethiopia: Challenges and opportunities* (pp. 241--284). Springer Nature.

van der Velden, N. M., Patel, M. K., & Vogtlander, J. G. (2013). LCA benchmarking study on textiles made of cotton, polyester, nylon, acryl, or elastane. *The International Journal of Life Cycle Assessment, 19*(2), 331--356.

Wiedemann, S. G., Biggs, L., Clarke, S. J., & Russell, S. J. (2022). Reducing the environmental impacts of garments through industrially scalable closed-loop recycling: Life cycle assessment of a recycled wool blend sweater. *Sustainability, 14*(3), 1081.

Wendin, M. (2007). *Underlag for miljostrategi for Dem Collective -- Livscykelanalys av t-shirt 2006* [Background for environmental strategy for Dem Collective -- LCA of T-shirt 2006]. Gothenburg, Sweden.
...
European Commission. (2024). *Environmental Footprint reference package* (EF 3.1). Joint Research Centre.

(Apparel Impact Institute / Made2Flow internal benchmark is intentionally cited as an *unpublished dataset*; all other items are citable external sources.)
