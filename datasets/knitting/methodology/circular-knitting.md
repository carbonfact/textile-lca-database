...
This document summarises the modelling approach for **circular knitting**, representing a typical industrial process for jersey fabric production.

The purpose is to make the process transparent and reproducible across studies, while allowing refinement as factory-specific data become available.

### 1.2 Scope and functional unit

- **Functional unit:** 1 kg of knitted fabric.
- **Technology:** single and double jersey circular knitting.
- **Included:** yarn losses/waste, lubricants, energy consumption, electricity, indirect energy allocation, capital goods and their end-of-life (EoL).
- **Excluded:** fibre and yarn manufacturing (modelled separately), building construction, packaging and logistics.
...
- Australian Cotton (2022). *Understanding yarn count and the uses of Australian cotton.*
- Banerjee, P. K. (2014). *Principles of Fabric Formation.* CRC Press.
- Burkinshaw, S. M. (2016). *Physico-chemical Aspects of Textile Colouration.* John Wiley & Sons.
- Celik, N. et al. (2025). *Design of a washing machine to clean the needle bed of an electronic flat knitting machine.* *JSIR*, 84(1), 17--23.
- Confederation of Indian Industry (n.d.). *Energy Efficiency in Compressed Air Systems.*
- Haque, A. N. M. A., & Naebe, M. (2024). *Future Textiles.* Deakin University.
- Hasanbeigi, A. (2010). *Energy-efficiency improvement opportunities for the textile industry (LBNL-3970E).*
- INTI (2021). *Product Category Rules: Textile Yarn and Thread.*
- ITMF (2010). *International Production Cost Comparison.*
- Kir, A., Ozturk, E., Yetis, U., & Kitis, M. (2024). *Resource utilisation in textile subsectors.* *Environmental Science and Pollution Research, 31*, 25312--25328.
- Koc, E., & Cincik, E. (2010). *Analysis of energy consumption in woven fabric production.* *Fibres & Textiles in Eastern Europe, 18*(2), 14--20.
- Laursen, S. E. et al. (2007). *EDIPTEX -- Environmental Assessment of Textiles.* Danish EPA.
- Liu, Z., Cano, F., & Ardanuy, M. (2025). *Effect of process conditions and lubricant application on yarn quality.* *AUTEX Research Journal.*
- Palamutcu, S. (2016). *Sustainable Textile Technologies.* In *Textiles and Clothing Sustainability.* Springer.
- Ray, S. C. (2012). *Fundamentals and Advances in Knitting Technology.* WPI Publishing.
- Sakti, S. et al. (2021). *Energy efficiency analysis in a textile company using DMAIC approach.* *IOP MSE*, 1096(1), 012007.
- Sandin, G. et al. (2019). *Environmental Assessment of Swedish Fashion Consumption -- Mistra Future Fashion.*
- van der Velden, N. M., Patel, M. K., & Vogtlander, J. G. (2014). *LCA Benchmarking Study on Textiles.* *Int. J. LCA.*
