...
- European Commission (2003). *IPPC -- Best Available Techniques for the Textiles Industry*.
- Fazio, S., Castellani, V., & Sala, S. (2020). *Guide for EF-compliant datasets*. JRC.
- Hasanbeigi, A. (2010). *Energy-Efficiency Improvement Opportunities for the Textile Industry*. LBNL.
- Idemat (2012). *Idemat Materials Database*.
- Kir, A. et al. (2024). *Resource utilisation in textile sub-sectors*. Environmental Science and Pollution Research.
- Koc, E., & Cincik, E. (2010). *Energy consumption in woven fabric production*. Fibres & Textiles in Eastern Europe.
- Laursen, S. E. et al. (2007). *EDIPTEX -- Environmental Assessment of Textiles*.
- Roos, S. et al. (2015). *Environmental Assessment of Swedish Fashion Consumption*. Mistra.
- Sakti, S. et al. (2021). *Energy efficiency analysis in a textile company*. IOP MSE.
- Sandin, G. et al. (2019). *Mistra Future Fashion Report*. IVL.
- van der Velden, N. M. et al. (2013). *LCA benchmarking of textiles*. Int. J. LCA.
- Weidema, B. P. et al. (2013). *Data Quality Guidelines for ecoinvent v3*.
- Celik, N. et al. (2025). *Design of a washing machine for needle-bed cleaning*. JSIR.
- ecoinvent Knowledge Base (Infrastructure handling & capital goods).
